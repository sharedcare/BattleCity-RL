...
class Game():
	...
	def __init__(self):
		...
		sprites = pygame.transform.scale(pygame.image.load(os.path.join(current_path,  "images/sprites.gif")), [192, 224])
		...
		if play_sounds:
			...
			sounds["start"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/gamestart.ogg"))
			sounds["end"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/gameover.ogg"))
			sounds["score"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/score.ogg"))
			sounds["bg"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/background.ogg"))
			sounds["fire"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/fire.ogg"))
			sounds["bonus"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/bonus.ogg"))
			sounds["explosion"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/explosion.ogg"))
			sounds["brick"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/brick.ogg"))
			sounds["steel"] = pygame.mixer.Sound(os.path.join(current_path,  "sounds/steel.ogg"))
		...
		# load custom font
		self.font = pygame.font.Font(os.path.join(current_path,  "fonts/prstart.ttf"), 16)
